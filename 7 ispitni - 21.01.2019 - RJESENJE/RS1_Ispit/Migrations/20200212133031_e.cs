        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prosjek = table.Column<float>(nullable: true),
                    Rezultat = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaturskiDetalji", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MaturskiDetalji_MaturskiIspit_MaturskiIspitID",
                        column: x => x.MaturskiIspitID,
                        principalTable: "MaturskiIspit",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaturskiDetalji_OdjeljenjeStavka_OdjeljenjeStavkaID",
                        column: x => x.OdjeljenjeStavkaID,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaturskiDetalji_MaturskiIspitID",
                table: "MaturskiDetalji",
                column: "MaturskiIspitID");

            migrationBuilder.CreateIndex(
                name: "IX_MaturskiDetalji_OdjeljenjeStavkaID",
                table: "MaturskiDetalji",
                column: "OdjeljenjeStavkaID");
